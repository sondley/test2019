...
describe('Accounts', function () {
    describe('get all', function () {
        ...
        before(function () {
            ...
            var client = { requesthandler: { request: requestStub } };
            options = { dog: 'cat' };
            ...
            var Accounts = proxyquire('../lib/accounts', {
    ...
    describe('get all with one account returned', function () {
        ...
        before(function () {
            ...
            var responseObject = { accounts: { account: expectedAccount } };
    ...
    describe('get specific account', function () {
        ...
        before(function () {
            ...
            var responseObject = { account: expectedAccount };
            parseStringStub = sinon.stub().callsArgWith(1, null, responseObject);
            var xmlParserStub = sinon.stub().returns({ parseString: parseStringStub });
            var Accounts = proxyquire('../lib/accounts', {
                './xmlparser': { XmlParser: xmlParserStub }
