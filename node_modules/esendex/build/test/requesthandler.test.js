...
describe('RequestHandler', function () {
    describe('constructor with defaults', function () {
        var request;
        before(function () {
            var Handlers = proxyquire('../lib/requesthandler', {});
    ...
    describe('with no request body', function () {
        ...
        before(function () {
            ...
            var responseHandlerHandle = sinon.stub().callsArgWith(2, null, responseBody);
            responseHandlerStub = sinon.stub().returns({ handle: responseHandlerHandle });
            var userAgentBuilderFake = { Build: sinon.stub().returns(expectedUserAgent) };
            ...
            var request = new Handlers.RequestHandler(options);
    ...
    describe('POST with a request body', function () {
        ...
        before(function () {
            ...
            var responseHandlerHandle = sinon.stub().callsArgWith(2, null, responseBody);
            var responseHandlerStub = sinon.stub().returns({ handle: responseHandlerHandle });
            var userAgentBuilderFake = { Build: sinon.stub().returns('asdhjahsdj') };
            callback = sinon.expectation.create().once();
            var Handlers = proxyquire('../lib/requesthandler', {
                'https': { request: requestStub },
                './responsehandler': { ResponseHandler: responseHandlerStub },
            ...
            var request = new Handlers.RequestHandler(null);
    ...
    describe('with socket timeout', function () {
        ...
        before(function () {
            ...
            var request = new Handlers.RequestHandler({ timeout: timeout });
    ...
    describe('with https disabled', function () {
        ...
        before(function () {
            ...
            var request = new Handlers.RequestHandler({ https: false });
...
//# sourceMappingURL=requesthandler.test.js.map
