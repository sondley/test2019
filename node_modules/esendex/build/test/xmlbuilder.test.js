...
describe('XmlBuilder', function () {
    ...
    before(function () {
        ...
        var xml2js = { Builder: function () { this.buildObject = buildObjectStub; } };
        builderSpy = sinon.spy(xml2js, 'Builder');
        objectToBuild = { Some: 'object' };
        var Builder = proxyquire('../lib/xmlbuilder', { 'xml2js': xml2js }).XmlBuilder;
        var builder = new Builder(rootName);
...
//# sourceMappingURL=xmlbuilder.test.js.map
