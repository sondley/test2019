...
var esendexfake_1 = require('./esendexfake');
var Esendex = require('../lib/index');
describe('Accounts Integration', function () {
    var esendexFake;
    var esendex;
    before(function (done) {
        var fakePort = process.env.PORT || 3000;
        esendexFake = new esendexfake_1.EsendexFake();
    ...
    describe('get all accounts', function () {
        ...
        it('should return an array of accounts', function () {
            assert.ok(util_1.isArray(accounts.account));
        });
...
//# sourceMappingURL=accounts.integration.test.js.map
